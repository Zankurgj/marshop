...
if ($.fn.slick != undefined) {
  ...
  $('.js-slider-extra').slick ({
    ...
    speed: 900,
    fade: true,
    nextArrow: '<div class="slider__arrow slider__arrow_next"><svg width="12" height="24" class="svg-icon"><use xlink:href="#icon-arrow-slider"></use></svg></div>',
    prevArrow: '<div class="slider__arrow slider__arrow_prev"><svg width="12" height="24" class="svg-icon"><use xlink:href="#icon-arrow-slider"></use></svg></div>',
    responsive: [
      {
        breakpoint: 769,
        settings: {
...
if($.fn.validate !== undefined) {
  ...
  $.validator.methods.email = function( value, element ) {
    return this.optional( element ) || /^[a-z0-9]+?@[a-z]+?\.[a-z]{2,}?$/.test( value );
  }
};
  ...
  if (btnFileInput.length > 0) {
    ...
    btnFileInput.on('change', function(){
      for(var i=0; i<this.files.length; i++){
        ...
        fileCnt++;
        var html = '<li class="file-block__item"><span class="file-block__name">' + file.name;
        html += '</span><span class="file-block__delete js-file-delete" data-file-id="' + fileCnt + '"><svg width="48" height="48" class="svg-icon"><use xlink:href="#icon-delete"></use></svg></span></li>';
